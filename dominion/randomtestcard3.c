...
int main() {
    ...
    while (time(NULL) - start < duration) {
        ...
        tributeEffect(&G2, tributePosition);
        tributeRevealedCards[0] = G2.discard[nextPlayer][G2.discardCount[nextPlayer]-1];
        tributeRevealedCards[1] = G2.discard[nextPlayer][G2.discardCount[nextPlayer]-2];
